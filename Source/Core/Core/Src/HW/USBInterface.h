...
struct USBDeviceDescriptorEtc : public USBDeviceDescriptor
{
	...
	bool IsOpen; // set by GetDeviceList
...
protected:
	// Returns a list of USBDeviceDescriptorEtcs to destroy
	std::vector<USBDeviceDescriptorEtc> SetDeviceList(std::vector<USBDeviceDescriptorEtc>&& List, bool IsInitial);
};
